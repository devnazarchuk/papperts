      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-12">
          <div className="relative h-[400px] w-full overflow-hidden rounded-2xl">
            <Image
              src="/images/Baeckerei_Pappert_veranstaltet_Alpentour_2025-768x512.jpg"
        ...
        <motion.div variants={itemVariants} className="mb-12">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div className="rounded-lg bg-white p-4 shadow-lg dark:bg-[#232323]">
              <p className="font-semibold text-[#D72638] dark:text-[#FFA5A5]">{translations.intro.period}</p>
            </div>
          </div>
        </motion.div>

        <motion.div variants={itemVariants} className="rounded-2xl bg-white p-8 shadow-lg dark:bg-[#232323]">
          <h2 className="mb-6 text-2xl font-bold text-[#D72638] dark:text-[#FFA5A5]">{translations.info.title}</h2>
          <div className="space-y-4">
            <p className="text-gray-700 dark:text-gray-300">{translations.info.start}</p>
            <p className="text-gray-700 dark:text-gray-300">{translations.info.trainer}</p>
            <p className="text-gray-700 dark:text-gray-300">{translations.info.price}</p>
            <motion.button
